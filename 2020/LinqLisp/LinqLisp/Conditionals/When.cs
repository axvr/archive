...
namespace LinqLisp
{
    public static partial class Conditionals
    {
        ...
        public static IOrderedEnumerable<TSource> When<TSource>(
        ...
        public static IQueryable<TSource> When<TSource>(
        ...
        public static IOrderedQueryable<TSource> When<TSource>(
